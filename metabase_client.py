...
Env vars:
    ...
    METABASE_API_KEY  — header value for X-API-KEY.
"""
...
METABASE_HOST = (
    ...
    or "https://metabase-prod.penpencil.co"
).rstrip("/")
...
def _post_once(url: str, body: Dict[str, Any], timeout: int) -> Dict[str, Any]:
...
def run_native_query(
    ...
    *,
    ...
    for attempt in range(2):  # 1 initial + 1 retry
        try:
            payload = _post_once(url, body, timeout)
            break
